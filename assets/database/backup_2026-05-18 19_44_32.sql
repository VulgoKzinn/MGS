...
-- Copiando dados para a tabela db_mgs.tb_img_vaga: ~10 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_login: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_match: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_perfil_candidato: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela db_mgs.tb_perfil_empresa: ~2 rows (aproximadamente)
INSERT INTO `tb_perfil_empresa` (`id`, `id_empresa`, `slogan`, `quem_somos`, `data_cadastro`, `ativo`) VALUES
	(1, NULL, 'A melhor do Brasil!', 'A Amazon é uma das maiores empresas de tecnologia e comércio eletrônico do mundo. Fundada em 1994 por Jeff Bezos, nos Estados Unidos, a empresa começou como uma livraria online e, ao longo dos anos, expandiu suas operações para diversos setores, como vend', '2026-05-16 17:51:31', 1),
	(2, NULL, 'A melhor do Brasil!', 'A Amazon é uma das maiores empresas de tecnologia e comércio eletrônico do mundo. Fundada em 1994 por Jeff Bezos, nos Estados Unidos, a empresa começou como uma livraria online e, ao longo dos anos, expandiu suas operações para diversos setores, como vend', '2026-05-16 17:55:21', 1),
	(3, NULL, 'A melhor do Brasil!', 'A Amazon é uma das maiores empresas de tecnologia e comércio eletrônico do mundo. Fundada em 1994 por Jeff Bezos, nos Estados Unidos, a empresa começou como uma livraria online e, ao longo dos anos, expandiu suas operações para diversos setores, como vend', '2026-05-16 17:59:16', 1);

-- Copiando dados para a tabela db_mgs.tb_perfil_empresa_img: ~2 rows (aproximadamente)
INSERT INTO `tb_perfil_empresa_img` (`id`, `perfil`, `capa`, `descricao`, `data_cadastro`, `ativo`, `id_empresa`) VALUES
	(1, '48473b779a159e90b677af62baa86dc6.png', 'c74996726b516730b20dc13d5dc0c0c1.jpg', '076dd4a7ed11715fc1e564627e272a4d.jpg', '2026-05-16 17:55:21', 1, NULL),
	(2, '23f063ba187834c883d8f52f46f450eb.png', '5fcdfc26b99ebc63df9ee88e23186c68.jpg', '14498b6f6e565fe029de3bc48d2290c0.jpg', '2026-05-16 17:59:16', 1, NULL);
...
-- Copiando dados para a tabela db_mgs.tb_vagas: ~10 rows (aproximadamente)
