...
-- Copiando dados para a tabela db_mgs.tb_empresa: ~7 rows (aproximadamente)
INSERT INTO `tb_empresa` (`id`, `id_login`, `nome_fantasia`, `rzsocial`, `telefone`, `complemento`, `cnpj`, `cep`, `atuacao`, `numero`, `ativo`, `data_cadastro`) VALUES
	...
	(16, 34, 'teste', 'teste', '(23) 45678', 'casa', '23.456.789', '23456-78', '2', '1234', 1, '2026-05-06 20:00:06');
...
-- Copiando dados para a tabela db_mgs.tb_img_vaga: ~2 rows (aproximadamente)
INSERT INTO `tb_img_vaga` (`id`, `imagem`, `data_cadastro`, `ativo`, `padrao`, `id_vaga`) VALUES
	(30, '87149829e65cec351c3935fc3658715f.jpg', '2026-05-06 21:23:42', 1, 0, 40),
	(31, 'c714635ea3baff7c560ac7294e660f97.jpg', '2026-05-06 21:24:03', 1, 0, 41);
...
INSERT INTO `tb_login` (`id`, `email`, `senha`, `data_cadastro`, `ativo`, `s_temp`, `id_nivel`) VALUES
	...
	(33, 'teste123@gmail.com', '$argon2id$v=19$m=65536,t=4,p=1$TlAyMERnYTgvQk1FRC5wLw$hVnaqYpTRWTXB/1hoLR11FHSaeErNHLaYGZDEQ0llhc', '2026-05-06 19:59:26', 1, 0, 1),
	(34, 'testenovo12@gmail.com', '$argon2id$v=19$m=65536,t=4,p=1$Z2xaYmRMUzlzcC91cG5oZw$eHE5GzP9ZTtg0iI6eNBhdXavBbsyLAoWdmXHbI7PajQ', '2026-05-06 19:59:52', 1, 0, 1);
...
-- Copiando dados para a tabela db_mgs.tb_vagas: ~2 rows (aproximadamente)
INSERT INTO `tb_vagas` (`id`, `id_empresa`, `vaga`, `area_atuacao`, `modalidade`, `localizacao`, `descricao`, `requisitos`, `salario`, `beneficio`, `carga_horaria`, `data_cadastro`, `ativo`, `modelo_de_trabalho`) VALUES
	(40, 11, 'Teste', 'Teste', 'Presencial', 'Sj', 'tudo', 'tudo', 1200.00, 'tudo', '1200 semanal', '2026-05-06 21:23:42', 1, 'Presencial'),
	(41, 11, 'Teste', 'Teste', 'Presencial', 'Sj', 'tudp', 'tudo', 1200.00, 'tudo', '1200 semanal', '2026-05-06 21:24:03', 1, 'Presencial');
